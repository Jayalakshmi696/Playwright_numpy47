...
test.describe('Accounts module functionality of suite8demo application', () => {
  ...
  test('Verify Create Account page navigation', { tag: ['@AccountsModule', '@Accounts2'] }, async ({ When, Then, page }) => { 
    await When('the user opens Accounts module and clicks Create Account', null, { page }); 
    await Then('the user should be navigated to Create Account page', null, { page }); 
  });
