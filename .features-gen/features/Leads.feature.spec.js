...
test.describe('Testing Leads module in SuiteCRM application', () => {
  ...
  test.describe('Verify that user is able to create a new Lead', () => {
    ...
    test('Example #1', { tag: ['@LeadsModule', '@CreateLeadFunctionality'] }, async ({ Given, When, Then }) => { 
      ...
      await When('User enters Leads Valid Data1 and clicks the Save button'); 
    ...
    test('Example #3', { tag: ['@LeadsModule', '@CreateLeadFunctionality'] }, async ({ Given, When, Then }) => { 
      await Given('User is on the Create Lead page'); 
      await When('User enters Leads Valid Data2 and clicks the Cancel button'); 
  ...
  test('Verify that user is on the vCard page', { tag: ['@LeadsModule', '@VCardpage'] }, async ({ Given, When, Then }) => { 
    ...
    await Then('User should see the import vCard page with correct components', {"dataTable":{"rows":[{"cells":[{"value":"Component"},{"value":"Expected Values"}]},{"cells":[{"value":"PageTitle"},{"value":"Import VCard"}]},{"cells":[{"value":"Buttons"},{"value":"Choose File, Import VCard"}]},{"cells":[{"value":"Label"},{"value":"Information text"}]}]}}); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":30,"pickleLine":36,"tags":["@LeadsModule","@CreateLeadFunctionality"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User launches the application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":31,"gherkinStepLine":31,"keywordType":"Context","textWithKeyword":"Given User is on the Create Lead page","stepMatchArguments":[]},{"pwStepLine":32,"gherkinStepLine":32,"keywordType":"Action","textWithKeyword":"When User enters Leads Valid Data1 and clicks the Save button","stepMatchArguments":[]},{"pwStepLine":33,"gherkinStepLine":33,"keywordType":"Outcome","textWithKeyword":"Then User should see Create Leads Detailed view page of new Lead","stepMatchArguments":[]}]},
  ...
  {"pwTestLine":42,"pickleLine":38,"tags":["@LeadsModule","@CreateLeadFunctionality"],"steps":[{"pwStepLine":7,"gherkinStepLine":5,"keywordType":"Context","textWithKeyword":"Given User launches the application","isBg":true,"stepMatchArguments":[]},{"pwStepLine":43,"gherkinStepLine":31,"keywordType":"Context","textWithKeyword":"Given User is on the Create Lead page","stepMatchArguments":[]},{"pwStepLine":44,"gherkinStepLine":32,"keywordType":"Action","textWithKeyword":"When User enters Leads Valid Data2 and clicks the Cancel button","stepMatchArguments":[]},{"pwStepLine":45,"gherkinStepLine":33,"keywordType":"Outcome","textWithKeyword":"Then User should see Create Leads Confirmation dialog appears","stepMatchArguments":[]}]},
